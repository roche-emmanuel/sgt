...
function Class:initialize()
  ...
  resLoader:addPath(root_path.."/proland_samples/terrain/terrain1");
  resLoader:addArchive(root_path.."/proland_samples/terrain/terrain1/helloworld.xml");
...
function Class:validPos(pos)
  return math.abs(pos:getX()) < 100000.0 and math.abs(pos:getY()) < 100000.0 and math.abs(pos:getZ()) < 100000.0;
end
