...
function Class:initialize()
  ...
  resLoader:addPath(root_path.."/proland_samples/terrain/terrain2");
  resLoader:addArchive(root_path.."/proland_samples/terrain/terrain2/helloworld.xml");
...
function Class:validPos(pos)
  return pos:length() < self._controller:getR()*1.1
end
