log:notice "Starting Proland graph1 test."
...
function Class:initialize()
  ...
  resLoader:addPath(root_path.."/proland_samples/graph/graph1");
  resLoader:addArchive(root_path.."/proland_samples/graph/graph1/helloworld.xml");
