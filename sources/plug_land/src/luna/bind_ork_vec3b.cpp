...
public:
	...
	inline static bool _lg_typecheck___mul_overload_1(lua_State *L) {
		...
		if( !Luna<void>::has_uniqueid(L,2,81304267) ) return false;
		if( (!(Luna< ork::vec3b >::check(L,2))) ) return false;
		return true;
	}
	...
	// Function binds:
	// bool ork::vec3b::length() const
	static int _bind_length(lua_State *L) {
		if (!_lg_typecheck_length(L)) {
			luaL_error(L, "luna typecheck failed in bool ork::vec3b::length() const function, expected prototype:\nbool ork::vec3b::length() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		ork::vec3b* self=(Luna< ork::vec3b >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool ork::vec3b::length() const. Got : '%s'\n%s",typeid(Luna< ork::vec3b >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	// bool ork::vec3b::squaredLength() const
	static int _bind_squaredLength(lua_State *L) {
		if (!_lg_typecheck_squaredLength(L)) {
			luaL_error(L, "luna typecheck failed in bool ork::vec3b::squaredLength() const function, expected prototype:\nbool ork::vec3b::squaredLength() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		ork::vec3b* self=(Luna< ork::vec3b >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call bool ork::vec3b::squaredLength() const. Got : '%s'\n%s",typeid(Luna< ork::vec3b >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
	...
	// ork::vec3b ork::vec3b::normalize() const
	static int _bind_normalize_overload_1(lua_State *L) {
		if (!_lg_typecheck_normalize_overload_1(L)) {
			luaL_error(L, "luna typecheck failed in ork::vec3b ork::vec3b::normalize() const function, expected prototype:\nork::vec3b ork::vec3b::normalize() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		ork::vec3b* self=(Luna< ork::vec3b >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call ork::vec3b ork::vec3b::normalize() const. Got : '%s'\n%s",typeid(Luna< ork::vec3b >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		ork::vec3b stack_lret = self->normalize();
	...
	// ork::vec3b ork::vec3b::normalize(bool l) const
	static int _bind_normalize_overload_2(lua_State *L) {
		if (!_lg_typecheck_normalize_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::vec3b ork::vec3b::normalize(bool l) const function, expected prototype:\nork::vec3b ork::vec3b::normalize(bool l) const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		ork::vec3b* self=(Luna< ork::vec3b >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call ork::vec3b ork::vec3b::normalize(bool) const. Got : '%s'\n%s",typeid(Luna< ork::vec3b >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		ork::vec3b stack_lret = self->normalize(l);
		ork::vec3b* lret = new ork::vec3b(stack_lret);
		if(!lret) return 0; // Do not write NULL pointers.
	...
	// Overload binder for ork::vec3b::normalize
	...
	// ork::vec3b ork::vec3b::operator+(const ork::vec3b & v) const
	static int _bind___add(lua_State *L) {
		if (!_lg_typecheck___add(L)) {
			luaL_error(L, "luna typecheck failed in ork::vec3b ork::vec3b::operator+(const ork::vec3b & v) const function, expected prototype:\nork::vec3b ork::vec3b::operator+(const ork::vec3b & v) const\nClass arguments details:\narg 1 ID = 81304267\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		ork::vec3b* self=(Luna< ork::vec3b >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call ork::vec3b ork::vec3b::operator+(const ork::vec3b &) const. Got : '%s'\n%s",typeid(Luna< ork::vec3b >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		ork::vec3b stack_lret = self->operator+(v);
		ork::vec3b* lret = new ork::vec3b(stack_lret);
		if(!lret) return 0; // Do not write NULL pointers.
	...
	// ork::vec3b ork::vec3b::operator*(const bool scalar) const
	static int _bind___mul_overload_2(lua_State *L) {
		if (!_lg_typecheck___mul_overload_2(L)) {
			luaL_error(L, "luna typecheck failed in ork::vec3b ork::vec3b::operator*(const bool scalar) const function, expected prototype:\nork::vec3b ork::vec3b::operator*(const bool scalar) const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		ork::vec3b* self=(Luna< ork::vec3b >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call ork::vec3b ork::vec3b::operator*(const bool) const. Got : '%s'\n%s",typeid(Luna< ork::vec3b >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		ork::vec3b stack_lret = self->operator*(scalar);
		ork::vec3b* lret = new ork::vec3b(stack_lret);
		if(!lret) return 0; // Do not write NULL pointers.
	...
	// Overload binder for ork::vec3b::operator*
	...
	// ork::vec3b ork::vec3b::operator-() const
	static int _bind___unm(lua_State *L) {
		if (!_lg_typecheck___unm(L)) {
			luaL_error(L, "luna typecheck failed in ork::vec3b ork::vec3b::operator-() const function, expected prototype:\nork::vec3b ork::vec3b::operator-() const\nClass arguments details:\n\n%s",luna_dumpStack(L).c_str());
		}


		ork::vec3b* self=(Luna< ork::vec3b >::check(L,1));
		if(!self) {
			luaL_error(L, "Invalid object in function call ork::vec3b ork::vec3b::operator-() const. Got : '%s'\n%s",typeid(Luna< ork::vec3b >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		ork::vec3b stack_lret = self->operator-();
		ork::vec3b* lret = new ork::vec3b(stack_lret);
		if(!lret) return 0; // Do not write NULL pointers.
...
luna_RegType LunaTraits< ork::vec3b >::methods[] = {
	{"length", &luna_wrapper_ork_vec3b::_bind_length},
	{"squaredLength", &luna_wrapper_ork_vec3b::_bind_squaredLength},
	{"normalize", &luna_wrapper_ork_vec3b::_bind_normalize},
	...
	{"__add", &luna_wrapper_ork_vec3b::_bind___add},
	{"__sub", &luna_wrapper_ork_vec3b::_bind___sub},
	{"__mul", &luna_wrapper_ork_vec3b::_bind___mul},
	{"__div", &luna_wrapper_ork_vec3b::_bind___div},
	{"__unm", &luna_wrapper_ork_vec3b::_bind___unm},
	{"__lt", &luna_wrapper_ork_vec3b::_bind___lt},
