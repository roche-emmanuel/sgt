#ifndef _WRAPPERS_WRAPPER_PROLAND_TWEAKHYDROGRAPHLAYER_H_
#define _WRAPPERS_WRAPPER_PROLAND_TWEAKHYDROGRAPHLAYER_H_
...
class wrapper_proland_TweakHydroGraphLayer : public proland::TweakHydroGraphLayer, public luna_wrapper_base {

public:
		

	~wrapper_proland_TweakHydroGraphLayer() {
		logDEBUG3("Calling delete function for wrapper proland_TweakHydroGraphLayer");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((proland::TweakHydroGraphLayer*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_proland_TweakHydroGraphLayer(lua_State* L, lua_Table* dum, bool active) 
		: proland::TweakHydroGraphLayer(active), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((proland::TweakHydroGraphLayer*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_proland_TweakHydroGraphLayer(lua_State* L, lua_Table* dum) 
		: proland::TweakHydroGraphLayer(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((proland::TweakHydroGraphLayer*)this);
			_obj.callFunction<void>();
...
protected:
	...
	void doRelease() {
		...
		return TweakHydroGraphLayer::doRelease();
	};
	...
	void updateBar(TwBar * bar) {
		...
		return TweakHydroGraphLayer::updateBar(bar);
	};
	...
	void createTweakBar() {
		...
		return TweakHydroGraphLayer::createTweakBar();
	};

	// void proland::TweakHydroGraphLayer::init(bool active)
	void init(bool active) {
		...
		return TweakHydroGraphLayer::init(active);
	};

	// void proland::TweakHydroGraphLayer::displayCurveInfo(TwBar * b, proland::EditGraphOrthoLayer::SelectionData * curveData)
	void displayCurveInfo(TwBar * b, proland::EditGraphOrthoLayer::SelectionData * curveData) {
		...
		return TweakHydroGraphLayer::displayCurveInfo(b, curveData);
	};
...
public:
	...
	const char * toString() {
		...
		return TweakHydroGraphLayer::toString();
	};
	...
	void reshape(int x, int y, bool & needUpdate) {
		...
		return TweakHydroGraphLayer::reshape(x, y, needUpdate);
	};
	...
	void idle(bool damaged, bool & needUpdate) {
		...
		return TweakHydroGraphLayer::idle(damaged, needUpdate);
	};
	...
	bool mouseWheel(ork::EventHandler::wheel b, ork::EventHandler::modifier m, int x, int y, bool & needUpdate) {
		...
		return TweakHydroGraphLayer::mouseWheel(b, m, x, y, needUpdate);
	};
	...
	bool mouseMotion(int x, int y, bool & needUpdate) {
		...
		return TweakHydroGraphLayer::mouseMotion(x, y, needUpdate);
	};
	...
	bool mousePassiveMotion(int x, int y, bool & needUpdate) {
		...
		return TweakHydroGraphLayer::mousePassiveMotion(x, y, needUpdate);
	};
	...
	bool keyTyped(unsigned char c, ork::EventHandler::modifier m, int x, int y, bool & needUpdate) {
		...
		return TweakHydroGraphLayer::keyTyped(c, m, x, y, needUpdate);
	};
	...
	bool keyReleased(unsigned char c, ork::EventHandler::modifier m, int x, int y, bool & needUpdate) {
		...
		return TweakHydroGraphLayer::keyReleased(c, m, x, y, needUpdate);
	};
	...
	bool specialKey(ork::EventHandler::key k, ork::EventHandler::modifier m, int x, int y, bool & needUpdate) {
		...
		return TweakHydroGraphLayer::specialKey(k, m, x, y, needUpdate);
	};
	...
	bool specialKeyReleased(ork::EventHandler::key k, ork::EventHandler::modifier m, int x, int y, bool & needUpdate) {
		...
		return TweakHydroGraphLayer::specialKeyReleased(k, m, x, y, needUpdate);
	};
	...
	void setActive(bool active) {
		...
		return TweakHydroGraphLayer::setActive(active);
	};
	...
	void redisplay(double t, double dt, bool & needUpdate) {
		...
		return TweakHydroGraphLayer::redisplay(t, dt, needUpdate);
	};
	...
	bool mouseClick(ork::EventHandler::button b, ork::EventHandler::state s, ork::EventHandler::modifier m, int x, int y, bool & needUpdate) {
		...
		return TweakHydroGraphLayer::mouseClick(b, s, m, x, y, needUpdate);
	};
	...
	static int _bind_public_closeMenu(lua_State *L) {
		...
		wrapper_proland_TweakHydroGraphLayer* self=Luna< ork::Object >::checkSubType< wrapper_proland_TweakHydroGraphLayer >(L,1);
		if(!self) {
