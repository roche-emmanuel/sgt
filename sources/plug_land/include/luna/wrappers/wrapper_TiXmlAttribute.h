#ifndef _WRAPPERS_WRAPPER_TIXMLATTRIBUTE_H_
#define _WRAPPERS_WRAPPER_TIXMLATTRIBUTE_H_
...
class wrapper_TiXmlAttribute : public TiXmlAttribute, public luna_wrapper_base {

public:
		

	~wrapper_TiXmlAttribute() {
		logDEBUG3("Calling delete function for wrapper TiXmlAttribute");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((TiXmlAttribute*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_TiXmlAttribute(lua_State* L, lua_Table* dum) 
		: TiXmlAttribute(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((TiXmlAttribute*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_TiXmlAttribute(lua_State* L, lua_Table* dum, const std::string & _name, const std::string & _value) 
		: TiXmlAttribute(_name, _value), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((TiXmlAttribute*)this);
			_obj.callFunction<void>();
	...
	wrapper_TiXmlAttribute(lua_State* L, lua_Table* dum, const char * _name, const char * _value) 
		: TiXmlAttribute(_name, _value), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((TiXmlAttribute*)this);
	...
	static int _bind_public_SkipWhiteSpace(lua_State *L) {
		...
		wrapper_TiXmlAttribute* self=Luna< TiXmlBase >::checkSubType< wrapper_TiXmlAttribute >(L,1);
		if(!self) {
