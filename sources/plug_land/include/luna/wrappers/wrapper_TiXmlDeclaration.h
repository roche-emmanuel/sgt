#ifndef _WRAPPERS_WRAPPER_TIXMLDECLARATION_H_
#define _WRAPPERS_WRAPPER_TIXMLDECLARATION_H_
...
class wrapper_TiXmlDeclaration : public TiXmlDeclaration, public luna_wrapper_base {

public:
		

	~wrapper_TiXmlDeclaration() {
		logDEBUG3("Calling delete function for wrapper TiXmlDeclaration");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((TiXmlDeclaration*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_TiXmlDeclaration(lua_State* L, lua_Table* dum) 
		: TiXmlDeclaration(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((TiXmlDeclaration*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_TiXmlDeclaration(lua_State* L, lua_Table* dum, const std::string & _version, const std::string & _encoding, const std::string & _standalone) 
		: TiXmlDeclaration(_version, _encoding, _standalone), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((TiXmlDeclaration*)this);
			_obj.callFunction<void>();
	...
	wrapper_TiXmlDeclaration(lua_State* L, lua_Table* dum, const char * _version, const char * _encoding, const char * _standalone) 
		: TiXmlDeclaration(_version, _encoding, _standalone), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((TiXmlDeclaration*)this);
	...
	wrapper_TiXmlDeclaration(lua_State* L, lua_Table* dum, const TiXmlDeclaration & copy) 
		: TiXmlDeclaration(copy), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((TiXmlDeclaration*)this);
			_obj.callFunction<void>();
	...
	const TiXmlDocument * ToDocument() const {
		...
		return TiXmlDeclaration::ToDocument();
	};
	...
	const TiXmlElement * ToElement() const {
		...
		return TiXmlDeclaration::ToElement();
	};
	...
	const TiXmlComment * ToComment() const {
		...
		return TiXmlDeclaration::ToComment();
	};
	...
	const TiXmlUnknown * ToUnknown() const {
		...
		return TiXmlDeclaration::ToUnknown();
	};
	...
	const TiXmlText * ToText() const {
		...
		return TiXmlDeclaration::ToText();
	};
	...
	const TiXmlDeclaration * ToDeclaration() const {
		...
		return TiXmlDeclaration::ToDeclaration();
	};
	...
	bool Accept(TiXmlVisitor * visitor) const {
		...
		return TiXmlDeclaration::Accept(visitor);
	};


	// Protected non-virtual methods:
	// void TiXmlDeclaration::CopyTo(TiXmlDeclaration * target) const
	void public_CopyTo(TiXmlDeclaration * target) const {
		return TiXmlDeclaration::CopyTo(target);
	};
	...
	// void TiXmlDeclaration::public_CopyTo(TiXmlDeclaration * target) const
	static int _bind_public_CopyTo(lua_State *L) {
		if (!_lg_typecheck_public_CopyTo(L)) {
			luaL_error(L, "luna typecheck failed in void TiXmlDeclaration::public_CopyTo(TiXmlDeclaration * target) const function, expected prototype:\nvoid TiXmlDeclaration::public_CopyTo(TiXmlDeclaration * target) const\nClass arguments details:\narg 1 ID = 89852901\n\n%s",luna_dumpStack(L).c_str());
		}

		TiXmlDeclaration* target=(Luna< TiXmlBase >::checkSubType< TiXmlDeclaration >(L,2));

		wrapper_TiXmlDeclaration* self=Luna< TiXmlBase >::checkSubType< wrapper_TiXmlDeclaration >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void TiXmlDeclaration::public_CopyTo(TiXmlDeclaration *) const. Got : '%s'\n%s",typeid(Luna< TiXmlBase >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
