...
class wrapper_ork_Texture3D : public ork::Texture3D, public luna_wrapper_base {

public:
		

	~wrapper_ork_Texture3D() {
		logDEBUG3("Calling delete function for wrapper ork_Texture3D");
		if(_obj.pushFunction("delete")) {
			//_obj.pushArg((ork::Texture3D*)this); // No this argument or the object will be referenced again!
			_obj.callFunction<void>();
		}
	};
	
	wrapper_ork_Texture3D(lua_State* L, lua_Table* dum, int w, int h, int d, ork::TextureInternalFormat tf, ork::TextureFormat f, ork::PixelType t, const ork::Texture::Parameters & params, const ork::Buffer::Parameters & s, const ork::Buffer & pixels) 
		: ork::Texture3D(w, h, d, tf, f, t, params, s, pixels), luna_wrapper_base(L) { 
		register_protected_methods(L);
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((ork::Texture3D*)this);
			_obj.callFunction<void>();
		}
	};
	wrapper_ork_Texture3D(lua_State* L, lua_Table* dum) 
		: ork::Texture3D(), luna_wrapper_base(L) { 
		register_protected_methods(L); 
		if(_obj.pushFunction("buildInstance")) {
			_obj.pushArg((ork::Texture3D*)this);
			_obj.callFunction<void>();
...
protected:
	...
	void doRelease() {
		...
		return Texture3D::doRelease();
	};

	// void ork::Texture3D::swap(ork::ptr< ork::Texture > t)
...
public:
	...
	const char * toString() {
		...
		return Texture3D::toString();
	};


	// Protected non-virtual methods:
	// void ork::Texture3D::init(int w, int h, int d, ork::TextureInternalFormat tf, ork::TextureFormat f, ork::PixelType t, const ork::Texture::Parameters & params, const ork::Buffer::Parameters & s, const ork::Buffer & pixels)
	void public_init(int w, int h, int d, ork::TextureInternalFormat tf, ork::TextureFormat f, ork::PixelType t, const ork::Texture::Parameters & params, const ork::Buffer::Parameters & s, const ork::Buffer & pixels) {
		return ork::Texture3D::init(w, h, d, tf, f, t, params, s, pixels);
	};
	...
	// void ork::Texture3D::public_init(int w, int h, int d, ork::TextureInternalFormat tf, ork::TextureFormat f, ork::PixelType t, const ork::Texture::Parameters & params, const ork::Buffer::Parameters & s, const ork::Buffer & pixels)
	static int _bind_public_init(lua_State *L) {
		if (!_lg_typecheck_public_init(L)) {
			luaL_error(L, "luna typecheck failed in void ork::Texture3D::public_init(int w, int h, int d, ork::TextureInternalFormat tf, ork::TextureFormat f, ork::PixelType t, const ork::Texture::Parameters & params, const ork::Buffer::Parameters & s, const ork::Buffer & pixels) function, expected prototype:\nvoid ork::Texture3D::public_init(int w, int h, int d, ork::TextureInternalFormat tf, ork::TextureFormat f, ork::PixelType t, const ork::Texture::Parameters & params, const ork::Buffer::Parameters & s, const ork::Buffer & pixels)\nClass arguments details:\narg 7 ID = 84580371\narg 8 ID = 85004853\narg 9 ID = 1381405\n\n%s",luna_dumpStack(L).c_str());
		}
		...
		if( !params_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg params in ork::Texture3D::public_init function");
		}
		const ork::Texture::Parameters & params=*params_ptr;
		const ork::Buffer::Parameters* s_ptr=(Luna< ork::Buffer::Parameters >::check(L,9));
		if( !s_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg s in ork::Texture3D::public_init function");
		}
		const ork::Buffer::Parameters & s=*s_ptr;
		const ork::Buffer* pixels_ptr=(Luna< ork::Object >::checkSubType< ork::Buffer >(L,10));
		if( !pixels_ptr ) {
			luaL_error(L, "Dereferencing NULL pointer for arg pixels in ork::Texture3D::public_init function");
		}
		const ork::Buffer & pixels=*pixels_ptr;

		wrapper_ork_Texture3D* self=Luna< ork::Object >::checkSubType< wrapper_ork_Texture3D >(L,1);
		if(!self) {
			luaL_error(L, "Invalid object in function call void ork::Texture3D::public_init(int, int, int, ork::TextureInternalFormat, ork::TextureFormat, ork::PixelType, const ork::Texture::Parameters &, const ork::Buffer::Parameters &, const ork::Buffer &). Got : '%s'\n%s",typeid(Luna< ork::Object >::check(L,1)).name(),luna_dumpStack(L).c_str());
		}
		self->public_init(w, h, d, tf, f, t, params, s, pixels);
