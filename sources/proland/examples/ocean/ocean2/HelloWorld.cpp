...
void init()
{
    preprocessAtmo(AtmoParameters(), "./proland_samples/ocean/ocean2");
    ...
    resLoader->addPath("./proland_samples/ocean/ocean2");
    resLoader->addPath("./proland_samples/ocean/ocean1");
    resLoader->addArchive("./proland_samples/ocean/ocean2/helloworld.xml");
